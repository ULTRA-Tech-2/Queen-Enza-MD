...
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ CONNECTED CORRECTLY TO WHATSAPP ✅\n│\n▣──────────────────────────────···'))}
if (connection == 'close') {
console.log(chalk.yellow(`🚩ㅤConnection closed, please delete the ${global.authFile} folder and rescan the QR code`))}
}
...
conn.welcome = '*╔══════════════*\n*╟🌼 @subject*\n*╠══════════════*\n*╟🍒 @user*\n*╟☃️ Welcome* \n*║*\n*╟📃︎ Description:*\n\n@desc\n\n*║*\n*╟💗 Enjoy your stay!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟🍑 @user*\n*╟😏 Good Bye MotherFucker Dont Come Back😠 👋🏻* \n*╚══════════════*'
conn.spromote = '*@user now admin☺️*'
conn.sdemote = '*@user now not an admin🥲*'
conn.sDesc = '*Description has been changed to*\n\n*New Description:* @desc'
conn.sSubject = '*Subject has been changed to*\n*New Name:* @subject'
conn.sIcon = '*Icon has been changed to*'
...
let bio = `🤖 Runing Time: ${uptime} ┃ 👑 MR Hex ULTRA Tech ┃ 𝚀𝚄𝙴𝙴𝙽 𝙴𝙽𝚉𝙰 𝙼𝙳 Enjoy Our Bot`
