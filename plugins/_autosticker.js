...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 8) return await this.sendButton(m.chat, '*THE VIDEO CANNOT LAST MORE THAN 7 SECONDS*', wm, [['Deactive Autosticker', '/disable autosticker']], m)
let img = await q.download()
if (!img) return
...
if (stiker) {
let img = await(await fetch('https://i.ibb.co/gJ24kYf/20230105-222542.png')).buffer()  
