...
if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗] Exmple: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/` 
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*[❗𝐈𝐍𝐅𝐎❗] exmple: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
...
await await m.reply(`*[❗𝐈𝐍𝐅𝐎❗] ERROR PLEASE TRY THIS (${usedPrefix}fb, ${usedPrefix}fb2, ${usedPrefix}fb3, ${usedPrefix}fb4, ${usedPrefix}fb5)*`)
}}
