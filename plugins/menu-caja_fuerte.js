...
${(conn.user.jid == global.conn.user.jid ? '' : `Jadibot: https://wa.me/${global.conn.user.jid.split`@`[0]}`)}
...
conn.sendHydrated(m.chat, str, wm, pp, 'https://wa.me/+923474187615', '𝙾𝚆𝙽𝙴𝚁', null, null, [
['𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻', '/menu']
], m)
}}
